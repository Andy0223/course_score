      ...
      <div class="row text-center">
        <table id="tb" style="border-collapse:collapse" align="center" cellpadding="10">
            ...
            while($record=mysqli_fetch_row($rs))
            {
                ...
                echo "<td><a href=index2.php?method=update&id=$record[0]><image src=img/pencil.png width=20px height=20px></a></td><td><a href=index2.php?method=delete&id=$record[0]><image src=img/trashcan.png width=20px height=20px></a></td>";
